...
primary		: literal
		...
		| primary_value tMETHREF operation2
			...
			$$ = NEW_METHREF($1, $3, &@$);
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$3;v3=dispatch2(methref,v1,v2);$$=v3;}
		    }
		;
...
block_param_def	: '|' opt_bv_decl '|'
		...
		| tOROP
			...
			$$ = 0;
#endif
			{VALUE v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,v11;v1=Qnil;v2=Qnil;v3=Qnil;v4=Qnil;v5=Qnil;v6=Qnil;v7=Qnil;v8=dispatch7(params,v1,v2,v3,v4,v5,v6,v7);v9=v8;v10=Qnil;v11=dispatch2(block_var,v9,v10);$$=v11;}
		    }
...
p_case_body	: keyword_in
		  ...
		  p_cases
			...
			$$ = NEW_IN($3, $6, $7, &@$);
#endif
			{VALUE v1,v2,v3,v4;v1=$3;v2=$6;v3=escape_Qundef($7);v4=dispatch3(in,v1,v2,v3);$$=v4;}
		    }
		;
...
#endif
			$$=rb_ary_new_from_args(1, rb_ary_new_from_args(2, get_value($1), get_value($2)));
		    }
		| tLABEL
		    {
...
#endif
			$$=rb_ary_new_from_args(1, rb_ary_new_from_args(2, get_value($1), Qnil));
		    }
...
#endif
			$$=rb_ary_new_from_args(1, rb_ary_new_from_args(2, $2, get_value($4)));
		    }
...
#endif
			$$=rb_ary_new_from_args(1, rb_ary_new_from_args(2, $2, Qnil));
		    }
		;
...
#endif
			$$=params_new(Qnone, Qnone, $1, Qnone, Qnone, Qnone, Qnone);
		    }
		| /* none */
		    {
			$$ = new_args_tail(p, Qnone, Qnone, Qnone, &@0);
