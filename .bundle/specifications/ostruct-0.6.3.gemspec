...
Gem::Specification.new do |s|
  ...
  s.files = [".gitignore".freeze, "BSDL".freeze, "COPYING".freeze, "Gemfile".freeze, "README.md".freeze, "Rakefile".freeze, "bin/console".freeze, "bin/setup".freeze, "lib/ostruct.rb".freeze, "ostruct.gemspec".freeze]
