...
Gem::Specification.new do |s|
  ...
  s.files = ["BSDL".freeze, "COPYING".freeze, "README.md".freeze, "Rakefile".freeze, "lib/prime.rb".freeze, "prime.gemspec".freeze, "sig/integer-extension.rbs".freeze, "sig/manifest.yaml".freeze, "sig/prime.rbs".freeze]
