...
Gem::Specification.new do |s|
  ...
  s.files = [".github/dependabot.yml".freeze, ".github/workflows/push_gem.yml".freeze, ".github/workflows/test.yml".freeze, ".gitignore".freeze, "BSDL".freeze, "COPYING".freeze, "Gemfile".freeze, "LICENSE.txt".freeze, "README.md".freeze, "Rakefile".freeze, "lib/net/ftp.rb".freeze, "net-ftp.gemspec".freeze]
