...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE.txt".freeze, "NEWS.md".freeze, "README.md".freeze, "lib/net/smtp.rb".freeze, "lib/net/smtp/auth_cram_md5.rb".freeze, "lib/net/smtp/auth_login.rb".freeze, "lib/net/smtp/auth_plain.rb".freeze, "lib/net/smtp/auth_xoauth2.rb".freeze, "lib/net/smtp/authenticator.rb".freeze]
