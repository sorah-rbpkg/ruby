...
Gem::Specification.new do |s|
  ...
  s.files = ["BSDL".freeze, "COPYING".freeze, "lib/matrix.rb".freeze, "lib/matrix/eigenvalue_decomposition.rb".freeze, "lib/matrix/lup_decomposition.rb".freeze, "lib/matrix/version.rb".freeze, "matrix.gemspec".freeze]
